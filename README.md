...
* Clone the project `git clone https://MuddyGames@bitbucket.org/MuddyGames/gameplay-programming-i-lab-12.git`

* Change to the project directory `cd projects gameplay-programming-i-lab-12`
